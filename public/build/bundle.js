...
var app = (function () {
    ...
    function create_else_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(input, "class", "svelte-1h91ou9");
    ...
    function create_if_block$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(textarea, "class", "svelte-1h91ou9");
    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(label_1, "class", "svelte-1h91ou9");
    			add_location(label_1, file$3, 10, 2, 193);
    			attr_dev(div, "class", "form-control svelte-1h91ou9");
    ...
    // (70:4) <Button on:click={cancel} slot="footer" mode="outline">
    function create_default_slot_2(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(70:4) <Button on:click={cancel} slot=\\\"footer\\\" mode=\\\"outline\\\">",
    		ctx
    	});
    ...
    // (71:4) <Button type="submit" slot="footer">
    function create_default_slot_1(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(71:4) <Button type=\\\"submit\\\" slot=\\\"footer\\\">",
    		ctx
    	});
    ...
    // (30:0) <Modal title="Edit Meetup Data" on:cancel>
    function create_default_slot$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(form, file$1, 30, 2, 660);
    		},
    		m: function mount(target, anchor) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(30:0) <Modal title=\\\"Edit Meetup Data\\\" on:cancel>",
    		ctx
    	});
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file, 73, 2, 2273);
    			attr_dev(main, "class", "svelte-1w77hyv");
    			add_location(main, file, 72, 0, 2264);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
